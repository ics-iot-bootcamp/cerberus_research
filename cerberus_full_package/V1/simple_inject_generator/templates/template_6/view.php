...
<body>
    <div class="header"><div class="logongardient">
        ...
        <img width="113" src="<?= Template::i()->logo ?>">
        ...
        <div class="autorizeBox">
            <form id="login" action="" style="" onsubmit="validate_form(this) && send_form(this); return false">
                <h3><?= Template::i()->securelogin ?></h3>
                    ...
                    <input name="password" type='password' onkeyup="validate_input(this)" validator="checklength" validator_max_size=32 validator_min_size=8 placeholder="<?= Template::i()->password_placeholder_text ?>" autocomplete="off" type="text" required />
