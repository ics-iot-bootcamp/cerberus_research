    ...
    render() {
        ...
        return (
            <tr>
                ...
                {this.props.isBotSelected ? <td><Link class="link" to={"/CC/" + this.props.idbot}>{this.props.idbot}</Link></td> : <React.Fragment />}
                <td>{this.props.application}</td>
                <td class="CCs" style={width}><div class="check-bot" style={textAlignCenter}><i class={this.LookBtnClass()} onClick={this.LookBtnClick.bind(this)}></i></div>{loglist}</td>
                <td style={CommentStyle}><EditCommentUniversal parentObj={this} idinj={this.props.idinj} text={_comment} request="editCommentLogsCC" /></td>
...
class CCsLogsTable extends React.Component {
    ...
    DownloadLogs() {
        ...
        let FileName = this.state.isBotSelected ? 'CCLogs.json' : 'CCLogs_' + this.props.botID + '.json';
        ...
        if (error) {
            ...
            return (
                <React.Fragment>
                    ...
                    {this.state.isModal ? (this.state.isBotSelected? <React.Fragment /> : <Link class="link gobackLink" to="/CC"><i class="far fa-chevron-circle-left"></i> Go to CC logs</Link>) : <React.Fragment />}
                    <table class="table table-striped table-dark table-hover ">
                        ...
                        <tbody>
                        {this.state.LogsList.map(item => (
                            <CCsLogsRow UpdateThisComponent={this.UpdateThisComponent.bind(this)} isBotSelected={this.state.isBotSelected} idinj={item.idinj} idbot={item.idbot} application={item.application} logs={item.logs} comment={item.comment} />
                        ))}
                        </tbody>
                    </table>
                </React.Fragment>
