        ...
        if (error) {
            ...
            return (
                <React.Fragment>
                    ...
                    {this.state.isModal ? (this.state.isBotSelected? <React.Fragment /> : <Link class="link gobackLink" to="/bank"><i class="far fa-chevron-circle-left"></i> Go to bank logs</Link>) : <React.Fragment />}
